...
import { ArrowLeft, Rocket, Calendar, Sparkles, Clock, CheckCircle, Target, Loader2, ShieldAlert, Cpu, Brain } from 'lucide-react';
...
const RemediationPlan: React.FC<Props> = ({ assessment, provider, plan, isGenerating, onGenerate, onBack }) => {
